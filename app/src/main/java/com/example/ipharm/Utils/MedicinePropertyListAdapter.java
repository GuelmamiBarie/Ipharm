...
import com.example.ipharm.MedicinesActivity;
import com.example.ipharm.R;

import java.util.List;
import java.util.regex.Pattern;

public class MedicinePropertyListAdapter extends ArrayAdapter<String>
{
    private static final String TAG = "medicinePropertyListAda";
    private LayoutInflater mInflater;
    private List<String> mProperties = null;
    private int layoutResource;
    private Context mContext;

    public MedicinePropertyListAdapter(@NonNull Context context, int resource, @NonNull List<String> properties)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        //******* here where you can change also.  ***************************************
        ...
        holder.property.setText(property);
            ...
            holder.leftIcon.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    if (((MedicinesActivity)mContext).checkPermission(Init.PHONE_PERMISSIONS))
                    {
                    ...
                    {
                        ((MedicinesActivity)mContext).verifyPermissions(Init.PHONE_PERMISSIONS);
                    }
                }
            });
